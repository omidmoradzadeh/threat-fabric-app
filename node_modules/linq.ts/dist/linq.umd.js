...
var linq = createCommonjsModule(function (module, exports) {
 ...
 */
const equal = (a, b) => Object.keys(a).every(key => (isObj(a[key]) ? commonjsGlobal._equal(b[key], a[key]) : b[key] === a[key]));
/**
...
class List {
     ...
     */
    SelectMany(selector) {
        return this.Aggregate((ac, v, i) => (ac.AddRange(this.Select(selector)
            .ElementAt(i)
            .ToArray()), ac), new List());
    }
    /**
    ...
    ToDictionary(key, value) {
        return this.Aggregate((o, v, i) => (o[this.Select(key)
            .ElementAt(i)
            .toString()] = value ? this.Select(value).ElementAt(i) : v, o), {});
    }
    /**
...
var linq$1 = unwrapExports(linq);
var linq_1 = linq.List;
var linq_2 = linq.Enumerable;

exports.default = linq$1;
exports.List = linq_1;
exports.Enumerable = linq_2;
